# Californa housing
This project is a school assignment containing a predictive modelling solution using Python's Scikit-learn machine learning modules using the California housing-datset. The notebook contains code, figures and result, and the decision brief is presented in a seperate pdf-file.

## Classification Assignment
Background: The client needs a tool to quickly assess new or un-analyzed areas. They have access to area features (geography, household composition, income levels, etc.) but not housing values. The goal is to rapidly answer: “Is this likely a high-value area?”
...
- `Decision brief.pdf` - summary of method, result, recommendations and risks
